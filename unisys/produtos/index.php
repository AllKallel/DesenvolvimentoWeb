	...
	$("#btnDeletar").click(function(){
		...
		if(id != false){
			...
			if (confirm("Confirma a exclusão?") == true){
				...
				jQuery("#produtosGrid").jqGrid('setGridParam',{url:'ajaxListarProdutos.php?txtNomeCategoria='+txtNome ,page:1}).trigger('reloadGrid');
			}	
		}else{
...
<div id="botoes" style="padding:4px 4px 4px 4px; color:#666; font-size:12px; font-weight:bold;">
    ...
    <input type="button" id="btnCadastrarCategoria" value="Cadastrar Categoria"/>
