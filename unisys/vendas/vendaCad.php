...
$(function() {
	...
	jQuery("#itemGrid").jqGrid('navGrid', '#itemsPagerGrid', {del:false,add:false,edit:false,search:false,refresh:true} );
	...
	function gravaItem(idVenda,idProduto,quant,precoVenda,desconto){
		$.ajax({
			...
			data:{},
			success: function(data, textStatus, request){
				var idItemVenda = data['idItemVenda'];
				refreshGrid(idItemVenda);
